...
export function showProperties(obj) {
    ...
    if(layoutModeGet()){
        ...
        $(moduleProperty.modulePropertyInner).append(`<p><span>Clock 34234324Time (ms):</span> <input class='objectPropertyAttribute' min='50' type='number' style='width:100px' step='10' name='changeClockTime'  value='${simulationArea.timePeriod}' aria-label='clock time'></p>`);
